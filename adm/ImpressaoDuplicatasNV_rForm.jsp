        ...
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="adm/ImpressaoDuplicatasNV_rForm.do" method="post" styleClass="baseForm">
              ...
              <%
              if(session.getAttribute("mostrar_grupo")!=null || session.getAttribute("somente_duplicatas")!=null || ((acesso.Usuario)session.getAttribute("User")).isTipo("CLIENTE MERCADO INTERNO") || session.getAttribute("grupo_economico")!=null ){
                %>
                        ...
                        <tr  class=<%= style %> >
                          ...
                          if(!(request.getParameter("excel")+"").equals("true")){
                            ...
                            <td class="reportColumn" style="text-align: left">
                              ...
                              %>
                              <%
                              if(lista.getPrt_codigo().equalsIgnoreCase("104")){
                                %>
                                <img src="../img/logo-caixa.png" style="max-width: 100px; max-height: 26px" />
                                <%
                              }
                              %>
                            </td>
