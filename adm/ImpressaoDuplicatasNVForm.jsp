...
<html>
  ...
  <script type="text/javascript">
    ...
    hashMapLabel.set("pesquisa_grupo","Pesquisa Por Grupo");
    ...
    hashMapLabel.set("grupo","Grupo Economico");
    hashMapLabel.set("cgc","CGC");
    hashMapLabel.set("mostrar_grupo","Grupo Econômico");
    hashMapLabel.set("cb_ordenar_data_vencimento","Ordenar por data de vencimento");
    ...
    hashMapLabel.set("data_vencimento_final","");
                  ...
                  <tr class="messageTr" >
                    <td class="messageTd">
                      <div style=font-size:11px;font-weight:normal;>
                        ...
                        if(((acesso.Usuario)session.getAttribute("User")).isTipo("CLIENTE MERCADO INTERNO")||((acesso.Usuario)session.getAttribute("User")).isTipo("CLIENTE MERCADO EXTERNO")){
                          ...
                          <%} else { %>
                            ...
                            <html:errors property="pesquisa_grupo"/>
                            <html:errors property="cb_ordenar_data_vencimento"/>
                      ...
                      <table class="itemTable"  style="width:99%;">
                        ...
                        <%
                        portalbr.adm.ImpressaoDuplicatasNVActionForm impressaoDuplicatasNVActionForm = (portalbr.adm.ImpressaoDuplicatasNVActionForm)session.getAttribute("ImpressaoDuplicatasNVActionForm");
                        acesso.Sessao sessao = new acesso.Sessao(session);
                        boolean liberaBanrisul = true;
                        boolean liberaBradesco = false;
                        boolean mostrarGrupo = false;
                        boolean pesquisaPorGrupo = false;
                        if(sessao.getUsuario().equalsIgnoreCase("ADMIN") || sessao.getUsuario().equalsIgnoreCase("151231")){
                          liberaBradesco = true;
                        }
                        if((impressaoDuplicatasNVActionForm.getMostrar_grupo()+"").equalsIgnoreCase("S")) {
                          mostrarGrupo = true;
                        }
                        if((impressaoDuplicatasNVActionForm.getPesquisa_grupo()+"").equalsIgnoreCase("S")){
                          pesquisaPorGrupo= true;
                        }
                        ...
                        if(cliente_mercado_externo.equals("")){
                          ...
                          <tr class="itemTr">
                            ...
                            <td class="formField">
                              <html:select property="banco" styleId="banco" styleClass="baseField" size="1">
                                ...
                                %>
                                <html:option styleClass="baseOption" value="104">
                          ...
                          <tr class="itemTr">
                            <td class="formLabel">
                              <span class="spamFormLabel">
                                Pesquisa por Grupo Economico
                              </span>
                            </td>
                            <td class="formField">
                              <html:checkbox property="pesquisa_grupo" styleId="pesquisa_grupo" onchange="refresh_action.click()" styleClass="baseField" value="S"/>
                            </td>
                          </tr>
                          ...
                          <%if(pesquisaPorGrupo) {%>
                            <tr class="itemTr">
                              ...
                              <td class="formField">
                                <html:text property="grupo" styleId="grupo" styleClass="baseField"/>
                              </td>
                            </tr>
                            <%}%>
                              ...
                              <tr class="itemTr">
                                ...
                                <td class="formField">
                                  ...
                                  <%
                                  if( (user.isTipo("AREAS") || user.isSuperUsuario()) && !pesquisaPorGrupo ){
                                    %>
                                    Abrir Grupo Econômico
                                    <html:checkbox property="mostrar_grupo" styleId="mostrar_grupo" onchange="refresh_action.click()" styleClass="baseField" value="S"/>
                                    <%
                                  } else {
                                    %>
                              ...
                              if(mostrarGrupo) {
                                ...
                                <tr class="itemTr">
                                  ...
                                  <td class="formField">
                                    <html:checkbox property="cb_ordenar_data_vencimento" styleId="cb_ordenar_data_vencimento" styleClass="baseField" value="S"/>
                                  </td>
                                </tr>
                                <%
                              } else {
                                %>
                                <html:hidden property="cb_ordenar_data_vencimento" value="N"/>
                                <%
                              }
                              %>
                            ...
                            <tr class="itemTr">
                              ...
                              <td class="formField">
                                ...
                                a
                                <html:text property="data_vencimento_final" styleId="data_vencimento_final" styleClass="baseField" size="10" maxlength="10"/>
                                <a tabindex="-1" href="javascript:var cal1 = new calendar1(document.forms['0'].elements['data_vencimento_final']); cal1.year_scroll = true; cal1.popup();">
                                  <img src="../img/calendar.gif" tabindex="9999" width="16" height="16" border="0" />
                                </a>
                            ...
                            || ((acesso.Usuario)session.getAttribute("User")).isTipo("REGIONAL DE VENDA")
                            ) {
                              %>
