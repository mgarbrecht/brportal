...
<html>
  ...
  <head>
    <title>
      Clientes Atendidos
      <%= request.getParameter("cab") != null ? (String)(request.getParameter("cab")+"").replace('*','&'): "" %>
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
              ...
              int counterbl_report_Jw_clientes_atendidos=0;
              {
                ...
                if (res_Jw_clientes_atendidos!=null && res_Jw_clientes_atendidos.size()>0) {
                  ...
                  <tr class="reportHeader" valign="bottom">
                    ...
                    <!--
                      <td class="columnTdHeader" style="text-align:right;"> Pares </td> <td class="columnTdHeader" style="text-align:right;"> Valor </td>
                    -->
                  ...
                  while (i_bl_report_Jw_clientes_atendidos<res_Jw_clientes_atendidos.size()){
                    ...
                    <tr <%= style %> id='TRbl_report_Jw_clientes_atendidos<%=counterbl_report_Jw_clientes_atendidos%>' >
                      ...
                      <!--
                        <td class="reportColumn" style="text-align:right;"> <% total_pares_recolocado += pares_recolocado; total_valor_recolocado += valor_recolocado; %> <% if(pares_recolocado>0) { %> <%= com.egen.util.text.FormatNumber.format(pares_recolocado, "###,###,##0") %> <% } else { %> <font color="gray">0</font> <% } %> </td> <td class="reportColumn" style="text-align:right;"> <% if(valor_recolocado > 0) { %> <%= com.egen.util.text.FormatNumber.format(valor_recolocado, "##,##0.00") %> <% } else { %> <font color="gray">0</font> <% } %> </td>
                      -->
                  ...
                  <!--
                    <td class="reportColumn" style="text-align:right;" > <b><%= com.egen.util.text.FormatNumber.format(total_pares_recolocado, "###,###,##0") %></b> </td> <td class="reportColumn" style="text-align:right;" > <b><%= com.egen.util.text.FormatNumber.format(total_valor_recolocado, "###,###,##0.00") %></b> </td>
                  -->
                </tr>

                <!--
                  <tr> <td class="reportColumn" style="text-align:right;" colspan="7"> <b>Total Geral:</b> </td> <td class="reportColumn" style="text-align:right;" colspan="2" > <b><%= com.egen.util.text.FormatNumber.format(total_pares+total_pares_recolocado, "###,###,##0") %></b> </td> <td class="reportColumn" style="text-align:right;" colspan="2" > <b><%= com.egen.util.text.FormatNumber.format(total_valor+total_valor_recolocado, "###,###,##0.00") %></b> </td> </tr>
                -->
          ...
          <html:form action="adm/Clientes_atend_quantidadeForm.do" method="post" styleClass="baseForm">
            ...
            <table class="itemTable"  style="width:99%;">
              ...
              <html:hidden property="atendimentos"/>
            </table>
