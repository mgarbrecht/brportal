...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/ImpressaoDuplicatasActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = ImpressaoDuplicatasActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="adm/ImpressaoDuplicatasForm.do" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:select property="emp_empresa" styleId="emp_empresa" onblur="fillFields(0,new Array('emp_empresa'),'ImpressaoDuplicatasActionForm.getEmp_razsoc_Ajax',new Array('emp_razsoc'));" styleClass="baseField" size="1">
