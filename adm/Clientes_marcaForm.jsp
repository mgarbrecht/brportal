      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <table id="TRbl_report_Clientes_marca" class="reportTable" style=width:99%;  border=1  frame=box>
              <%
              ...
              <html:form action="adm/Clientes_marcaForm.do" method="post" styleClass="baseForm">
                <table class="messageTable" style='width:99%;'>
                  <tr class="messageTr" >
                    <td class="messageTd">
                      <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Clientes_marca"/>
                    </td>
                  </tr>
                </table>
