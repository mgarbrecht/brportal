...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/PedidosBloqueadosActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = PedidosBloqueadosActionForm;
    ...
    hashMapLabel.set("codigo_regional_analise","");
  ...
  <center>
    <body onload="if(document.forms[0].reg.value=='' && document.forms[0].rep.value==''){document.forms[0].codigo_regional.focus();}else{document.forms[0].dt_inicial.focus();}">
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(79)){
            ...
            <html:form action="adm/PedidosBloqueadosForm.do" method="post" styleClass="baseForm" target="_self">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Jw_pedidos_bloqueados"/>
                  </td>
                </tr>
              </table>
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                if((codigo_regional.equals(""))&&(codigo_representante.equals(""))){
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'PedidosBloqueadosActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3" maxlength="3"/>
                ...
                <html:hidden property="codigo_regional_analise"/>
              </table>
