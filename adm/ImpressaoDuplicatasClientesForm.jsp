          ...
          <td class="mainTd">
            ...
            <table id="TRbl_report_Jw_consulta_titulos" class="reportTable" style=width:99%;  border=1  frame=box>
              ...
              int counterbl_report_Jw_consulta_titulos=0;
              {
                ...
                portalbr.adm.ImpressaoDuplicatasClientesActionForm ImpressaoDuplicatasClientesActionForm = (portalbr.adm.ImpressaoDuplicatasClientesActionForm)session.getAttribute("ImpressaoDuplicatasClientesActionForm");
                    ...
                    <tr class=<%= style %> id='TRbl_report_Jw_consulta_titulos<%=counterbl_report_Jw_consulta_titulos%>' >
                      <td class="reportColumn" style="text-align:left;" title="Títulos do Cliente: <%= razao %>">
                        ...
                        if(codigo_sucessor.equals("null")||codigo_sucessor.equals("")) {
                          %>
                          <a href="../adm/ImpressaoDuplicatas_rForm.do?select_action=&esc_seqn=<%= esc_seqn %>&cli_cdgo=<%= cli_cdgo %>&dt_venc=<%= ImpressaoDuplicatasClientesActionForm.getDt_venc() %>&situacao=<%= ImpressaoDuplicatasClientesActionForm.getSituacao() %>&codigo=<%= cliente %>&nome=<%= razao %>&bairro=<%= br %>&cidade_uf=<%= cid_est %>&emp_empresa=<%= ImpressaoDuplicatasClientesActionForm.getEmp_empresa() %>" target="_self" STYLE="cursor:hand">
                            <%= cliente %>
                          </a>
                          <%
                        } else {
                          ...
                          <a href="../adm/ImpressaoDuplicatas_rForm.do?select_action=&esc_seqn=<%= sequencial_sucessor %>&cli_cdgo=<%= codigo_sucessor %>&dt_venc=<%= ImpressaoDuplicatasClientesActionForm.getDt_venc() %>&situacao=<%= ImpressaoDuplicatasClientesActionForm.getSituacao() %>&codigo=<%= codigo_sucessor %>&nome=<%= razao_social_sucessor %>&bairro=<%= br_sucessor %>&cidade_uf=<%= cid_uf_sucessor  %>&emp_empresa=<%= ImpressaoDuplicatasClientesActionForm.getEmp_empresa() %>" target="_self" STYLE="cursor:hand">
                            <%= codigo_sucessor %>
                            -
                            <%= sequencial_sucessor %>
                          </a>
            ...
            <html:form action="adm/ImpressaoDuplicatasClientesForm.do" method="post" styleClass="baseForm">
