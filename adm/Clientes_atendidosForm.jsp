                          ...
                          (!(codigo_representante.equals("")))){
                            ...
                            <tr>
                              ...
                              <td class="formField">
                                ...
                                <%
                                if(opcao.equals("3")||opcao.equals("4")) {
                                  %>
                                  <html:hidden property="cb_consulta_clientes" value="S"/>
                                  <html:hidden property="cb_consulta_grupos" value="N"/>
                                  <html:hidden property="cb_consulta_cidades" value="N"/>
                                  <html:hidden property="cb_saldo_limite_credito" value="N"/>
                                  <html:hidden property="cb_consulta_segmentos" value="N"/>
                                  <html:hidden property="cb_consulta_regionais" value="N"/>
                                  <html:hidden property="cb_abrir_meses" value="S"/>
                                  <%
                                } else {
                                  %>
                                  ...
                                  <table border=1 style="border-color:#f4c5a2">
                                    ...
                                    <tr>
                                      ...
                                      <td align="center">
                                        <html:checkbox property="cb_abrir_meses" styleClass="baseField" value="S"/>
                                      </td>
                                    </tr>
                                  </table>
                                  <%
