            ...
            <table id="TRbl_report_Clientes_marca_regional" class="reportTable" style=width:99%;  border=1  frame=box>
              ...
              try {
                ...
                if (res_Clientes_marca_regional!=null && res_Clientes_marca_regional.size()>0) {
                  ...
                  grupos_ativos          = t_clientes_marca_regional.getGrupos_ativos();
                  grupos_atendidos       = t_clientes_marca_regional.getGrupos_atendidos();
                  grupos_nao_atendidos   = t_clientes_marca_regional.getGrupos_nao_atendidos();
                  ...
                  while (i_bl_report_Clientes_marca_regional<res_Clientes_marca_regional.size()){
                    ...
                    <tr class="reportHeader2" >
                      <td colspan=12>
                        ...
                        <%= marca %>
                        <%
                        util.consultas.TotaisClientesAtendidos totalMarca = new util.consultas.TotaisClientesAtendidos(session,codigo_marca+"", "null");
                        %>
                      </td>
                    </tr>
                    <%
                    ...
                    <tr class="reportHeader" valign="top">
                      ...
                      while (i_bl_report_Clientes_marca_regional<res_Clientes_marca_regional.size() &&  (b0_marca==null?"":b0_marca).equals((marca==null?"":marca))){
                        ...
                        %>
                        <tr class=<%= style %> id='TRbl_report_Clientes_marca_regional<%=counterbl_report_Clientes_marca_regional%>'  >
                          ...
                          if(session.getAttribute("ca_consulta_grupos")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Ativos da Regional: <%= regional %>" >
                              ...
                              if(Integer.parseInt(grupos_ativos+"")>0) {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/GruposAtivosForm.do?select_action=&cod=<%= codigo_marca %>&cod_marca=<%= codigo_marca %>&cod_regional=<%= codigo_regional %>&grupo=da Regional : <%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Atendidos da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(grupos_atendidos+"")>0) {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/GruposAtendidosForm.do?select_action=&cod=<%= codigo_marca %>&cod_marca=<%= codigo_marca %>&cod_regional=<%= codigo_regional %>&grupo=da Regional : <%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Não Atendidos da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(grupos_nao_atendidos+"")>0) {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/GruposNaoAtendidosForm.do?select_action=&cod=<%= codigo_marca %>&cod_marca=<%= codigo_marca %>&cod_regional=<%= codigo_regional %>&grupo=da Regional : <%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                          ...
                          if(session.getAttribute("ca_consulta_clientes")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Clientes Ativos da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(clientes_ativos+"")>0) {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/Clientes_ativosForm.do?select_action=&codigo_marca=<%= codigo_marca %>&codigo_regional=<%= codigo_regional %>&cab=da Regional : <%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Clientes Atendidos da Regional: <%= regional %>">
                              ...
                              if(!(request.getParameter("excel")+"").equals("true")){
                                %>
                                <a href="../adm/Clientes_atendForm.do?select_action=&codigo_marca=<%= codigo_marca %>&codigo_regional=<%= codigo_regional %>&cab=da Regional :<%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Clientes Não Atendidos da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(clientes_nao_atendidos+"")>0) {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/Clientes_nao_atendidosForm.do?select_action=&codigo_marca=<%= codigo_marca %>&codigo_regional=<%= codigo_regional %>&cab=da Regional : <%= regional %>" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                          ...
                          if(session.getAttribute("ca_consulta_cidades")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Cidades Ativas da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(cidades_ativas+"")>0)   {
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/Cidades_ativasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&codigo_marca=<%= codigo_marca %>&cab_cidade=da Regional : <%= regional %>&chamador=/adm/Clientes_marca_regionalForm.jsp" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Cidades Atendidas da Regional: <%= regional %>">
                              ...
                              if(!(request.getParameter("excel")+"").equals("true")){
                                %>
                                <a href="../adm/Cidades_atendidasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&codigo_marca=<%= codigo_marca %>&cab_cidade=da Regional : <%= regional %>&chamador=/adm/Clientes_marca_regionalForm.jsp" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Cidades Não Atendidas da Regional: <%= regional %>">
                              ...
                              if(Integer.parseInt(cidades_nao_atendidas+"")>0){
                                ...
                                if(!(request.getParameter("excel")+"").equals("true")){
                                  %>
                                  <a href="../adm/Cidades_nao_atendidasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&codigo_marca=<%= codigo_marca %>&cab_cidade=da Regional : <%= regional %>&chamador=/adm/Clientes_marca_regionalForm.jsp" target="_self" STYLE="cursor:hand" onclick="bloqueia();">
                    ...
                    <html:form action="adm/Clientes_marca_regionalForm.do" method="post" styleClass="baseForm">
                      <table class="messageTable" style='width:99%;'>
                        <tr class="messageTr" >
                          <td class="messageTd">
                            <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Clientes_marca_regional"/>
                          </td>
                        </tr>
                      </table>
