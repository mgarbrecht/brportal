      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <table id="TRbl_report_Clientes_representante" class="reportTable" style=width:99%;  border=1  frame=box>
              <%
              ...
              try {
                ...
                if (res_Clientes_representante!=null && res_Clientes_representante.size()>0) {
                  ...
                  regional               = t_clientes_representante.getRegional()==null?"":t_clientes_representante.getRegional();
                  ...
                  rep_nome               = t_clientes_representante.getRep_nome()==null?"":t_clientes_representante.getRep_nome();
                  grupos_ativos          = t_clientes_representante.getGrupos_ativos();
                  grupos_atendidos       = t_clientes_representante.getGrupos_atendidos();
                  grupos_nao_atendidos   = t_clientes_representante.getGrupos_nao_atendidos();
                  ...
                  cidades_ativas         = t_clientes_representante.getCidades_ativas();
                  cidades_atendidas      = t_clientes_representante.getCidades_atendidas();
                  cidades_nao_atendidas  = t_clientes_representante.getCidades_nao_atendidas();
                  pares                  = Integer.parseInt(t_clientes_representante.getPares()+"");
                  valor                  = Double.parseDouble(t_clientes_representante.getValor()+"");
                  ...
                  while (i_bl_report_Clientes_representante<res_Clientes_representante.size()){
                    ...
                    <tr class="reportHeader2" >
                      <td colspan=12>
                        ...
                        <%= regional %>
                        <%
                        util.consultas.TotaisClientesAtendidos totalRegional = new util.consultas.TotaisClientesAtendidos(session,"null",codigo_regional+"");
                        %>
                      </td>
                    </tr>
                    <%
                    ...
                    b0_codigo_regional =  Integer.parseInt(codigo_regional+"");
                    %>
                    ...
                    <tr class="reportHeader" valign="top">
                      ...
                      <%
                      while (i_bl_report_Clientes_representante<res_Clientes_representante.size() &&  b0_codigo_regional==Integer.parseInt(codigo_regional+"")){
                        counterbl_report_Clientes_representante++;
                        String style="";
                        ...
                        %>
                        <tr class=<%= style %> id='TRbl_report_Clientes_representante<%=counterbl_report_Clientes_representante%>' >
                          ...
                          if(session.getAttribute("ca_consulta_grupos")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Ativos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(grupos_ativos+"")>0) {
                                %>
                                <a href="../adm/GruposAtivosForm.do?select_action=&cod_rep=<%= rep_cdgo %>&grupo=do Representante : <%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Atendidos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(grupos_atendidos+"")>0) {
                                %>
                                <a href="../adm/GruposAtendidosForm.do?select_action=&cod_rep=<%= rep_cdgo %>&grupo=do Representante : <%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Grupos Não Atendidos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(grupos_nao_atendidos+"")>0) {
                                %>
                                <a href="../adm/GruposNaoAtendidosForm.do?select_action=&cod_rep=<%= rep_cdgo %>&grupo=do Representante : <%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                          ...
                          if(session.getAttribute("ca_consulta_clientes")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Clientes Ativos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(clientes_ativos+"")>0) {
                                %>
                                <a href="../adm/Clientes_ativosForm.do?select_action=&rep_cdgo=<%= rep_cdgo %>&cab=do Representante : <%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Clientes Atendidos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              <a href="../adm/Clientes_atendForm.do?select_action=&rep_cdgo=<%= rep_cdgo %>&cab=do Representante :<%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                            ...
                            <td class="reportColumn" style="text-align:center;"title="Clientes Não Atendidos do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(clientes_nao_atendidos+"")>0) {
                                %>
                                <a href="../adm/Clientes_nao_atendidosForm.do?select_action=&rep_cdgo=<%= rep_cdgo %>&cab=do Representante : <%= rep_nome.replace('&','*') %>" target="_self" STYLE="cursor:hand">
                          ...
                          if(session.getAttribute("ca_consulta_cidades")=="S"){
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Cidades Ativas do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              ...
                              if(Integer.parseInt(cidades_ativas+"")>0) {
                                %>
                                <a href="../adm/Cidades_ativasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&rep_cdgo=<%= rep_cdgo %>&cab_cidade=do Representante : <%= rep_nome.replace('&','*') %>&chamador=/adm/Clientes_representanteForm.jsp" target="_self" STYLE="cursor:hand">
                            ...
                            <td class="reportColumn" style="text-align:center;" title="Cidades Atendidas do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              <a href="../adm/Cidades_atendidasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&rep_cdgo=<%= rep_cdgo %>&cab_cidade=do Representante : <%= rep_nome.replace('&','*') %>&chamador=/adm/Clientes_representanteForm.jsp" target="_self" STYLE="cursor:hand">
                                <%= com.egen.util.text.FormatNumber.format(cidades_atendidas, "##,##0.##")  %>
                              </a>
                            </td>
                            <td class="reportColumn" style="text-align:center;" title="Cidades Não Atendidas do Representante: <%=rep_cdgo%>-<%= rep_nome %>">
                              <%
                              if(Integer.parseInt(cidades_nao_atendidas+"")>0){
                                %>
                                <a href="../adm/Cidades_nao_atendidasForm.do?select_action=&codigo_regional=<%= codigo_regional %>&rep_cdgo=<%= rep_cdgo %>&cab_cidade=do Representante : <%= rep_nome.replace('&','*') %>&chamador=/adm/Clientes_representanteForm.jsp" target="_self" STYLE="cursor:hand">
                      ...
                      <html:form action="adm/Clientes_representanteForm.do" method="post" styleClass="baseForm">
