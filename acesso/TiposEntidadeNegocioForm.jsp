      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="acesso/TiposEntidadeNegocioForm.do" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="tien_id" styleClass="baseField" size="10"/>
                  </td>
                </tr>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="tien_campos_descr" styleClass="baseField" size="80" maxlength="255"/>
                  </td>
                </tr>

                <html:hidden property="tien_campos_chave"/>
                <html:hidden property="tien_condicional"/>
              </table>
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  ...
                  <SCRIPT>
                    ...
                    <html:button accesskey="i" value="Cadastrar Novo Tipo de Entidade de Negócio" onclick="insert_action.click();" styleClass="baseButton" property="insert1_action">
                    </html:button>
                    ...
                    <html:submit styleClass="myhidden" property="insert_action">
