...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/AcessosTrocaIdentidade_iActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = AcessosTrocaIdentidade_iActionForm;
  ...
  <head>
    <title>
      Troca de Identidade - Liberação de Acessos - Inclusão
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="acesso/AcessosTrocaIdentidade_iForm.do" method="post" styleClass="baseForm">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Acessos_troca_identidade"/>
                  </td>
                </tr>
              </table>
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="atid_usua_id" styleId="atid_usua_id" onblur="fillFields(0,new Array('atid_usua_id'),'AcessosTrocaIdentidade_iActionForm.getUsua_nome_Ajax',new Array('usua_nome'));" styleClass="baseField" size="10" maxlength="23"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="atid_tien_id" styleId="atid_tien_id" onblur="fillFields(0,new Array('atid_tien_id'),'AcessosTrocaIdentidade_iActionForm.getTien_tipo_Ajax',new Array('tien_tipo'));" styleClass="baseField" size="10" maxlength="11"/>
