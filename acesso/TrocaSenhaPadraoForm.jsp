...
<html>
  ...
  <script type="text/javascript">
    ...
    hashMapLabel.set("usua_id","Usuário");
    hashMapLabel.set("usua_usuario","Usuário");
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  <td class="buttonTd">
                    ...
                    <html:submit accesskey="s" value="Senha Padrão" styleClass="baseButton" property="select_action">
                    </html:submit>
