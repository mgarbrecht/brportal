...
<% if(!pageName.equalsIgnoreCase("ConsultaPedidosForm.jsp")){ %>
...
<script>
 ...
 <% if(user.mostraQuery()){ %>  
  oCMenu.makeMenu('m0','',' <img src="../img/cb_checked.png" onclick="jQuery.post(\'../system/LogonForm.do?mostra_query_action=\',function( data ) { location.reload();});" height="16"> Query','','',100)
 <% } else { %>
  oCMenu.makeMenu('m0','',' <img src="../img/cb_unchecked.png" onclick="jQuery.post(\'../system/LogonForm.do?mostra_query_action=\',function( data ) { location.reload();});" height="16"> Query','','',100)
  <% }} %>
...
//oCMenu.makeMenu('m3','',' <img src="../img/ajuda.gif" height="16"><bean:message bundle="ApplicationResources" key="header.ajuda"/>','javascript:ajuda()','',100)
