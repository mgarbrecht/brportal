...
<font color=""><br><b>Período de </b></font><font color="#C40000" size=1><b><%= (String)session.getAttribute("dt_inicial") %></font><font color=""> até </font><font color="#C40000" size=1><%= (String)session.getAttribute("dt_final") %></b></font>
</td>
</tr>
</table>
