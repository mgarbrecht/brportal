                ...
                if (res_Jw_prazos_municipios!=null && res_Jw_prazos_municipios.size()>0) {
                  ...
                  <table id="TRbl_report_Jw_prazos_municipios"  class="reportTable"   style="width:99%; "  border="1" >
                    ...
                    <tr class="reportTr">
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","codigo")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","codigo")%>' class="reportOrder">
                      ...
                      <td class="columnTdHeader" style="text-align:left;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","descricao")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","descricao")%>' class="reportOrder">
                            <bean:message key="report.ordereddesc"/>
                          </a>
                          <%
                        }
                      ...
                      <td class="columnTdHeader" style="text-align:left;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","distrito")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","distrito")%>' class="reportOrder">
                            <bean:message key="report.ordereddesc"/>
                          </a>
                          <%
                        }
                      ...
                      <td class="columnTdHeader" style="text-align:center;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","codigo_ibge")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","codigo_ibge")%>' class="reportOrder">
                            <bean:message key="report.ordereddesc"/>
                          </a>
                          <%
                        }
                      ...
                      <td class="columnTdHeader" style="text-align:center;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","est_unifed")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","est_unifed")%>' class="reportOrder">
                            <bean:message key="report.ordereddesc"/>
                          </a>
                          <%
                        }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","prazo_entrega")%>' class="reportOrder">
                            <bean:message key="report.orderedasc"/>
                          </a>
                          <%
                        } else {
                          %>
                          <a href='MunicipiosPrazos_raForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","prazo_entrega")%>' class="reportOrder">
                            <bean:message key="report.ordereddesc"/>
                          </a>
                          <%
                        }
                    ...
                    while (i_bl_report_Jw_prazos_municipios<res_Jw_prazos_municipios.size()) {
                      ...
                      id = t_jw_prazos_municipios.getId();
                      ...
                      <tr class='<%= style_bl_report_Jw_prazos_municipios %>' id="TRbl_report_Jw_prazos_municipios<%=i_bl_report_Jw_prazos_municipios%>" >
                        ...
                        <td class="reportColumn" style="text-align:left;" >
                          <a href="../com/MunicipiosPrazos_aaForm.do?select_action=&id=<%= id %>" style="cursor:hand">
                            <%= descricao %>
                          </a>
...
<html:form action="com/MunicipiosPrazos_raForm.do" method="post" styleClass="baseForm">
