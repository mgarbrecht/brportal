    ...
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
                  ...
                  while (i_bl_report_Links_dinamicos<res_Links_dinamicos.size()){
                    ...
                    <tr <%= style %> id='TRbl_report_Links_dinamicos<%=counterbl_report_Links_dinamicos%>' >
                      ...
                      <td title="Editar Norma" class="reportColumn" style="font-size:10;text-align:left;">
                        ...
                        <%= lidi_titulo %>
                        <!--
                          <a href="../com/NormasVenda_aForm.do?pop_action=&pos=<%=i_bl_report_Links_dinamicos %>&lidi_id=<%= lidi_id %>&lidi_titulo=<%= lidi_titulo %>&lidi_descricao=<%= lidi_descricao %>&lidi_caminho=<%= lidi_caminho %>&lidi_marca=<%= lidi_marca %>" target="_self" STYLE="cursor:hand"> </a>
                        -->
                      </td>
                      <td class="reportColumn" style="font-size:9;text-align:left;">
                        <%= lidi_caminho.replace("/com/normas_vendas/","../") %>
                      </td>
                      <td class="reportColumn" style="font-size:10;text-align:center;">
                        <%= tipo %>
                      </td>
                      <td class="reportColumn" style="font-size:10;text-align:center;">
                        <a onclick="if(!(confirm('Confirma Exclusão?'))){return false;}"  href="../com/NormasVenda_rForm.do?delete_action=&pos=<%=i_bl_report_Links_dinamicos %>&lidi_id=<%= lidi_id %>&lidi_caminho=<%= lidi_caminho %>" target=_self STYLE=cursor:hand>
          ...
          <html:form action="com/NormasVenda_rForm.do" method="post" styleClass="baseForm">
