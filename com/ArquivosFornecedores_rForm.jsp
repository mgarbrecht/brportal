      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/ArquivosFornecedores_rGrid.do" method="post" styleClass="baseForm">
              ...
              if(res_Jw_geracao_romaneio_filtro != null && res_Jw_geracao_romaneio_filtro.size()>0){
                ...
                <table class="itemGridTable" style='width:99%;' border=1>
                  ...
                  String style;
                  %>
                  <logic:iterate id="bl_form_Jw_geracao_romaneio_filtro_lines" name="ArquivosFornecedores_rGridActionForm" property="bl_form_Jw_geracao_romaneio_filtro_lines" indexId="indexId">
