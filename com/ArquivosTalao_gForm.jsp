      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/ArquivosTalao_gForm.do" method="post" styleClass="baseForm">
                    ...
                    <tr>
                      <td class=columHeader style="text-align:center;">
                        ...
                        if(arquivo.indexOf(".zip")!=-1){
                          ...
                          %>
                          <a href="<%= arquivo %>" target="_blank" onclick="jQuery.post('ArquivosTalao_gForm.do?update_action=&tipo=v',function(){window.close();})">
