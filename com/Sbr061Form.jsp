...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/Sbr061ActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = Sbr061ActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(91)){
            ...
            <html:form action="com/Sbr061Form.do" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                if((codigo_regional.equals(""))&&(codigo_representante.equals(""))){
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="regional" onblur="fillFields(0,new Array('regional'),'Sbr061ActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3" maxlength="3"/>
                ...
                if(codigo_representante.equals("")){
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="rep_cdgo" onblur="fillFields(0,new Array('rep_cdgo'),'Sbr061ActionForm.getRep_rzao_Ajax',new Array('rep_rzao'));" styleClass="baseField" size="5" maxlength="5"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="pf_marca_ini" onblur="fillFields(0,new Array('pf_marca_ini'),'Sbr061ActionForm.getDescricao_marca_Ajax',new Array('descricao_marca'));" styleClass="baseField" size="3" maxlength="3"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="pf_marca_fim" onblur="fillFields(0,new Array('pf_marca_fim'),'Sbr061ActionForm.getDescricao_marca1_Ajax',new Array('descricao_marca1'));" styleClass="baseField" size="3" maxlength="3"/>
