...
<html>
  ...
  <head>
    <title>
      Cadastro de Estágios das Amostras
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(178)){
            ...
            <html:form action="com/EstagiosAmostrasGrid.do" method="post" styleClass="baseForm">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Ped_amostra_estagios"/>
                  </td>
                </tr>
              </table>
              ...
              <table class="itemGridTable" style='width:99%;'>
                ...
                <logic:iterate id="bl_form_Ped_amostra_estagios_lines" name="EstagiosAmostrasGridActionForm" property="bl_form_Ped_amostra_estagios_lines" indexId="indexId">
                  <tr class="trGridField">
                    <html:hidden property="estagio_cdgo" name="bl_form_Ped_amostra_estagios_lines" indexed="true" styleId="estagio_cdgo"/>
                    <td class="tdGridField">
                      <html:text property="descricao" styleId="descricao" onchange="setarAlterado(this.name,0,event);" onkeydown="setarAlterado(this.name,0,event);" onkeypress="setarAlterado(this.name,0,event);" styleClass="baseField" size="60" maxlength="60" name="bl_form_Ped_amostra_estagios_lines" indexed="true"/>
                    </td>

                    <td class="tdGridField">
                      <html:text property="ordem" styleId="ordem" onchange="setarAlterado(this.name,0,event);" onkeydown="setarAlterado(this.name,0,event);" onkeypress="setarAlterado(this.name,0,event);" styleClass="baseField" size="22" maxlength="22" name="bl_form_Ped_amostra_estagios_lines" indexed="true"/>
                    </td>

                    <html:hidden property="excluir" value="1" name="bl_form_Ped_amostra_estagios_lines" indexed="true" styleId="excluir"/>
                    <html:hidden property="banco" name="bl_form_Ped_amostra_estagios_lines" indexed="true" styleId="banco"/>
                    <html:hidden property="alterado" name="bl_form_Ped_amostra_estagios_lines" indexed="true" styleId="alterado"/>
                    <html:hidden property="pos" name="bl_form_Ped_amostra_estagios_lines" indexed="true" styleId="pos"/>
                  </tr>
              ...
              <table class="itemTable" style='width:99%;'>
                <%
                {
                  %>
                  <%
                  java.util.Vector res_Ped_amostra_estagios = (java.util.Vector)session.getAttribute("res_Ped_amostra_estagios");
                  %>
                  <%
                  String pos = "0";
                  if (res_Ped_amostra_estagios!=null) {
                    pos = "" + res_Ped_amostra_estagios.size();
                  }
                  %>
                </table>
                  ...
                  <table class="buttonTable" style='width:99%;'>
                    <tr class="buttonTr">
                      <td class="buttonTd">
                        ...
                        <html:submit accesskey="a" disabled="true" styleClass="myhidden" property="delete_action">
                ...
                <script type="text/javascript">
                  var focusControl = document.forms[0].elements["estagio_cdgo"][0];
