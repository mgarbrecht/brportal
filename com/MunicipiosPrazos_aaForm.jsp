...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/MunicipiosPrazos_aaActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = MunicipiosPrazos_aaActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/MunicipiosPrazos_aaForm.do" method="post" styleClass="baseForm">
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="codigo" styleId="codigo" onblur="fillFields(0,new Array('codigo'),'MunicipiosPrazos_aaActionForm.getDescricao_municipio_Ajax',new Array('descricao_municipio','codigo_ibge'));" styleClass="disabled" tabindex="-1" readonly="true" size="5" maxlength="20"/>
