...
<html>
  ...
  <head>
    <title>
      Arquivos de Representantes - Cadastro
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/ArquivosRepresentantes_iForm.do" enctype="multipart/form-data" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                <html:hidden property="lidi_tipo" value="R"/>
                <tr class="itemTr">
                  <td class="formLabel">
                    <span class="spamFormLabel">
                      Arquivo
