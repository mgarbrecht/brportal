...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/MunicipiosPrazos_aActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = MunicipiosPrazos_aActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/MunicipiosPrazos_aForm.do" method="post" styleClass="baseForm">
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:select property="est_unifed" styleId="est_unifed" onblur="fillFields(0,new Array('codigo','est_unifed'),'MunicipiosPrazos_aActionForm.getDescricao_municipio_Ajax',new Array());" styleClass="baseField" size="1">
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="codigo" styleId="codigo" onblur="if(this.value!=''){fillFields(0,new Array('codigo','est_unifed'),'MunicipiosPrazos_aActionForm.getDescricao_municipio_Ajax',new Array());}else{descricao_municipio.value='';}" styleClass="baseField" size="6" maxlength="22"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="distrito" styleId="distrito" styleClass="baseField" size="60" maxlength="60"/>
                  </td>
                </tr>
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  ...
                  <SCRIPT>
                    ...
                    <html:button accesskey="p" value="Cadastrar Novo Prazo por Municipio/Distrito" onclick="cadastrar_action.click();" styleClass="baseButton" property="cadastrar1_action"></html:button>
                    ...
                    <html:submit value="Cadastrar Novo Prazo por Municipio/Distrito" styleClass="myhidden" property="cadastrar_action"></html:submit>
                    </td>
                    </tr>
                    </table>
