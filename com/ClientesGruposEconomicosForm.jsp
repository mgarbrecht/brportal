...
<html>
  ...
  <script type="text/javascript">
    ...
    hashMapLabel.set("descricao_grupo","Descrição Grupo");
    hashMapLabel.set("situacao_cliente","Situação Cliente");
    hashMapLabel.set("situacao_cliente_grupo","Situação Cliente/Grupo Econômico");
    hashMapLabel.set("situacao_cliente_representante","Situação Cliente/Representante");
