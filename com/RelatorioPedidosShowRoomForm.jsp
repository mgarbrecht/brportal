...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/RelatorioPedidosShowRoomActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = RelatorioPedidosShowRoomActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/RelatorioPedidosShowRoomForm.do" method="post" styleClass="baseForm">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Jw_acao_mkt_relatorio_showroom"/>
                  </td>
                </tr>
              </table>
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="codigo_regional" styleId="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'RelatorioPedidosShowRoomActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="5" maxlength="22"/>
