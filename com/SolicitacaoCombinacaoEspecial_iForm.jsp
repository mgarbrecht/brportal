...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/SolicitacaoCombinacaoEspecial_iActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = SolicitacaoCombinacaoEspecial_iActionForm;
    ...
    hashMapLabel.set("f_alerta","");
    hashMapLabel.set("libera_valores","Libera valores acima de 100 reais");
  ...
  <head>
    <title>
      Solicitação de Combinações Especiais - Cadastro
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/SolicitacaoCombinacaoEspecial_iForm.do" enctype="multipart/form-data" method="post" styleClass="baseForm">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="libera_valores"/>
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                portalbr.com.SolicitacaoCombinacaoEspecial_iActionForm solicitacaoActionForm = (portalbr.com.SolicitacaoCombinacaoEspecial_iActionForm)session.getAttribute("SolicitacaoCombinacaoEspecial_iActionForm");
                %>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:select property="subtipo_solicitacao_comb_espec" styleId="subtipo_solicitacao_comb_espec" styleClass="baseField" size="1">
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    ...
                    <html:text property="lin_cdgo" styleId="lin_cdgo" onblur="fillFields(0,new Array('lin_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getLin_nome_Ajax',new Array('lin_nome'));" styleClass="baseField" size="7" maxlength="22"/>
                    ...
                    <input type="button" tabindex="-1" class="lovButton" value="Fotos Linha" onclick="if(document.forms[0].lin_cdgo.value==''){alert('Informe a linha!');}else{wopen('../ind/FotosLinhaResumoForm.do?select_action=&lin_cdgo='+document.forms[0].lin_cdgo.value,'_blank',800,500)}"  >
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    ...
                    if(session.getAttribute("v_numeracao")==null){
                      %>
                      <input type="button" class="lovButton" value="Informar Grade"  onclick="if(document.forms[0].lin_cdgo.value==''){alert('Informe a linha!');}else{wopen('../com/SolicitacaoCombinacaoEspecial_gForm.do?select1_action=&lin_cdgo1='+document.forms[0].lin_cdgo.value,'_blank',640,110)}"  >
                      <%
                    }
                    %>
                    <%
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="ref_cdgo" styleId="ref_cdgo" onblur="if(this.value!=''){fillFields(0,new Array('lin_cdgo','ref_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getRef_cdgo_Ajax',new Array('ref_desc','codigo_marca'));} else {document.forms[0].ref_desc.value='';}" styleClass="baseField" size="6"/>
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="cab_cdgo" styleId="cab_cdgo" onblur="fillFields(0,new Array('cab_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getCab_desc_Ajax',new Array('cab_desc'));" styleClass="baseField" size="5" maxlength="22"/>
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="cor_cdgo" styleId="cor_cdgo" onblur="fillFields(0,new Array('cor_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getCor_desc_Ajax',new Array('cor_desc'));" styleClass="baseField" size="6" maxlength="22"/>
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="data_entrega_amostra" styleId="data_entrega_amostra" styleClass="baseField" size="19" maxlength="19"/>
                    </td>
                  </tr>
                ...
                <div style="border:2px solid #dec693">
                  <table class="itemTable"  style="width:99%;">
                    ...
                    <tr class="itemTr">
                      ...
                      <tr class="itemTr">
                        ...
                        <td class="formField">
                          <html:text property="forro" styleClass="baseField" size="50" maxlength="2000"/>
                        </td>
                      </tr>
                  ...
                  <div style="border:2px solid #dec693">
                    <table class="itemTable"  style="width:99%;">
                      ...
                      <tr class="itemTr">
                        ...
                        <td class="formField">
                          <html:text property="rep_cdgo" styleId="rep_cdgo" onblur="fillFields(0,new Array('rep_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getRep_rzao_Ajax',new Array('rep_rzao')); fillFields(0,new Array('rep_cdgo'),'SolicitacaoCombinacaoEspecial_iActionForm.getCodigo_regional_Ajax',new Array('codigo_regional'));" styleClass="baseField" size="5"/>
                      ...
                      <tr class="itemTr">
                        ...
                        <td class="formField">
                          <html:text property="codigo_regional" styleId="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'SolicitacaoCombinacaoEspecial_iActionForm.getNome_regional_Ajax',new Array('nome_regional'));" onchange="fillFields(0,new Array('codigo_regional'),'SolicitacaoCombinacaoEspecial_iActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="disabled" tabindex="-1" readonly="true" size="5"/>
                          <span class="spamFormLabel">
                          </span>
                      ...
                      <tr class="itemTr">
                        ...
                        <td class="formField">
                          <html:text property="gre_grupo" styleId="gre_grupo" onblur="fillFields(0,new Array('gre_grupo'),'SolicitacaoCombinacaoEspecial_iActionForm.getGre_descricao_Ajax',new Array('gre_descricao'));" styleClass="baseField" size="6" maxlength="6"/>
                  ...
                  <table class="itemTable"  style="width:99%;">
                    ...
                    <tr class="itemTr">
                      ...
                      <td class="formField">
                        <html:select property="situacao_solicitacao" disabled="true" styleId="situacao_solicitacao" styleClass="disabled" size="1">
                    ...
                    if(request.getAttribute("solicitacao")!=null){
                      %>
                      <script>
                        alert('Solicitacao <%= request.getAttribute("solicitacao") %> inserida com sucesso!');
                      </script>
                    ...
                    <tr class="itemTr">
                      <td class="formLabel">
                        <span class="spamFormLabel">
                          Libera valores acima de 100 reais
                        </span>
                      </td>
                      <td class="formField">
                        <html:checkbox property="libera_valores" styleId="libera_valores" styleClass="baseField" value="1"/>
                      </td>
                    </tr>
                    ...
                    <tr class="itemTr">
                      ...
                      <td class="formField">
                        <html:text property="item" styleId="item" onblur="fillFields(0,new Array('pedido','item'),'SolicitacaoCombinacaoEspecial_aActionForm.getItem_desc_Ajax',new Array('item_desc'));" styleClass="disabled" readonly="true"/>
                  ...
                  <table class="buttonTable" style='width:99%;'>
                    <tr class="buttonTr">
                      <td class="buttonTd">
                        <html:button accesskey="i" onclick="resetfull1_action.disabled=true;this.disabled=true;document.forms[0].insert_action.click();"  styleClass="baseButton" property="insert1_action">
                        ...
                        <script>
                          function getKeySite(keyStroke) {
                            ...
                            keyBuffer = which;
                            if(eventChooser == 13){
                            if(document.forms[0].insert1_action.disabled==true){return false;}
                            document.forms[0].insert1_action.disabled=true;
                            document.forms[0].resetfull1_action.disabled=true;
                            document.forms[0].insert_action.click();
                          }
                        }
                      </script>
                      <SCRIPT>
