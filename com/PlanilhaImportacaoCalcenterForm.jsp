...
<html>
  ...
  <head>
    <title>
      Planilha Para Importação Cal Center
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(281)){
            ...
            <html:form action="com/PlanilhaImportacaoCalcenterForm.do" method="post" styleClass="baseForm">
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:textarea property="pedidos" styleId="pedidos" onblur="this.value = this.value.replace(/^\s+|\s+$/g,'');" styleClass="baseField" cols="60" rows="4"/>
                  </td>
                </tr>
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  ...
                  <SCRIPT>
                    ...
                    <html:submit accesskey="p" value="Gerar Planilha" styleClass="myhidden" property="select_action"></html:submit>
                    ...
                    var focusControl = document.forms[0].elements["pedidos"];
