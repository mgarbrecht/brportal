...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/Sbr073ActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = Sbr073ActionForm;
  ...
  <head>
    <title>
      Clientes Atendidos por Regional e Linha
    </title>
  </head>
  <center>
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(92)){
            ...
            <html:form action="com/Sbr073Form.do" method="post" styleClass="baseForm" target="_self">
              ...
              if(codigo_regional.equals("")){
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="regional" onblur="fillFields(0,new Array('regional'),'Sbr073ActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3" maxlength="3"/>
              ...
              <tr class="itemTr">
                ...
                <td class="formField">
                  <html:text property="codigo_marca" onblur="fillFields(0,new Array('codigo_marca'),'Sbr073ActionForm.getDescricao_marca_Ajax',new Array('descricao_marca'));" styleClass="baseField" size="3" maxlength="3"/>
