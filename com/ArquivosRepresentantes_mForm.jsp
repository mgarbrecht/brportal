...
<html>
  ...
  <head>
    <title>
      Inclusão de Arquivos - Representantes
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/ArquivosRepresentantes_mForm.do" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  <td class="buttonTd">
                    ...
                    <html:submit accesskey="i" value="Cadastrar Arquivo" styleClass="baseButton" property="insert_action">
                    </html:submit>
                  </td>
                </tr>
              </table>
