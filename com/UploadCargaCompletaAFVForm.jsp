      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(129)){
            ...
            <html:form action="com/UploadCargaCompletaAFVForm.do" enctype="multipart/form-data" method="post" styleClass="baseForm" target="_self">
