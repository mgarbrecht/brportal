...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/ClientesEspeciaisAnaliticoActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = ClientesEspeciaisAnaliticoActionForm;
    ...
    hashMapLabel.set("rep_cdgo","");
    var reportColumns = new Array();
  </script>
  <bean:message key="page.ajaxscript"/>
  <head>
    <title>
      Relatório de Clientes Especiais - Analítico Mensal
    </title>
  </head>
  <center>
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(126)){
            ...
            <html:form action="com/ClientesEspeciaisAnaliticoForm.do" method="post" styleClass="baseForm" target="_self">
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                (codigo_representante.equals(""))
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'ClientesEspeciaisAnaliticoActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3" maxlength="3"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="cli_cdgo" onblur="fillFields(0,new Array('cli_cdgo'),'ClientesEspeciaisAnaliticoActionForm.getCli_rzao_Ajax',new Array('cli_rzao'));" styleClass="baseField" size="10" maxlength="22"/>
