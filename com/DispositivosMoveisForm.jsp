      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="com/DispositivosMoveisForm.do" method="post" styleClass="baseForm">
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="codigo_usuario" styleId="codigo_usuario" styleClass="baseField" size="10" maxlength="30"/>
                  </td>
                </tr>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:select property="id_tablet" styleId="id_tablet" styleClass="baseField" size="1">
                      <html:options property="id_tabletList" labelProperty="id_tabletLabelList" styleClass="baseOptions"/>
                    </html:select>
                  </td>
                </tr>
