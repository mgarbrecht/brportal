  ...
  <center>
    <body>
      <table class="mainTable" style='width:100%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <html:form action="com/DiarioCombinacaoEspecial_gGrid.do" method="post" styleClass="baseForm">
              ...
              <table class="itemGridTable" style='width:100px;'>
                ...
                <tr class="trGridField">
                  <logic:iterate id="bl_form_Jw_grade_solicitacao_especial_lines" name="DiarioCombinacaoEspecial_gGridActionForm" property="bl_form_Jw_grade_solicitacao_especial_lines" indexId="indexId">
            ...
            <html:form action="com/DiarioCombinacaoEspecial_gForm.do" method="post" styleClass="baseForm">
