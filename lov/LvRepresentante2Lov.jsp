...
<center>
  <body onload="if(opener.document.forms[0].reg.value!=''){document.forms[0].codigo_regional.value=opener.document.forms[0].reg.value;}else{document.forms[0].codigo_regional.value=opener.document.forms[0].regional.value;}">
    <table class="mainTable" style='width:500;'>
      <tr class="mainTr">
        <td class="mainTd">
          ...
          <html:form action="lov/LvRepresentante2Lov.do" method="post" styleClass="baseForm" target="_self">
                      ...
                      function setLov(REP_CDGO,REP_RZAO) {
                        <% {
                          ...
                          if (request.getParameter("returnBlock")!=null) {
                            ...
                            session.setAttribute("ge_LovPage", "LvRepresentante2Lov");
                          } else if (session.getAttribute("ge_LovPage")!=null && ((String)session.getAttribute("ge_LovPage")).equals("LvRepresentante2Lov")) {
