  ...
  <center>
    <body onload="document.forms[0].ies_codigo.value = opener.document.forms[0].codigo.value">
      <table class="mainTable" style='width:500;'>
        <tr class="mainTr">
          <td class="mainTd">
            <html:form action="lov/LvConsumoComposicaoMaterialLov.do" method="post" styleClass="baseForm">
              <table class="messageTable" style='width:500;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Jw_consumo_composicao_material"/>
                  </td>
                </tr>
              </table>
            ...
            <%
            {
              ...
              <form  name="bl_report_Jw_consumo_composicao_material" id="bl_report_Jw_consumo_composicao_material" class="baseForm" method="post" >
                    ...
                    while (i_bl_report_Jw_consumo_composicao_material<res_Jw_consumo_composicao_material.size()) {
                      ...
                      <tr class='<%= style_bl_report_Jw_consumo_composicao_material %>' id="TRbl_report_Jw_consumo_composicao_material<%=i_bl_report_Jw_consumo_composicao_material%>" >
                        ...
                        <td class="reportColumn" style="text-align:left;" >
                          <a href="javascript:setLov('<%= mat_nro %>','<%= descricao %>')" style="cursor:hand">
                            <%= descricao %>
                          </a>
                ...
                <script type="text/javascript">
                  function setLov(MAT_NRO,DESCRICAO) {
                    <% {
                      ...
                      if (request.getParameter("returnBlock")!=null) {
                        ...
                        session.setAttribute("ge_LovPage", "LvConsumoComposicaoMaterialLov");
                      } else if (session.getAttribute("ge_LovPage")!=null && ((String)session.getAttribute("ge_LovPage")).equals("LvConsumoComposicaoMaterialLov")) {
                      ...
                      if (opener.document.forms[returnBlock].<%= return0%>!=null) { opener.document.forms[returnBlock].<%= return0 %>.value=MAT_NRO; };
                      <%}%>
