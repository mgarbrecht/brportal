...
<html>
  ...
  <head>
    <title>
      Maiores Clientes por Limite de Crédito
    </title>
  </head>
  <center>
    <body>
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
                    ...
                    <tr class="reportTr">
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","codigo")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","codigo")%>' class="reportOrder">
                      ...
                      <td class="columnTdHeader" style="text-align:left;" width="30%" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","razao")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","razao")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:left;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","tipo")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","tipo")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","limite")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","limite")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","pedidos_nao_liberados")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","pedidos_nao_liberados")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","pedidos_producao")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","pedidos_producao")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","p_vlr_vencer")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","p_vlr_vencer")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","p_vlr_vencido")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","p_vlr_vencido")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
                      ...
                      <td class="columnTdHeader" style="text-align:right;" >
                        ...
                        if(!(request.getParameter("excel")+"").equals("true")){
                          ...
                          if ( (request.getParameter("_reverse")==null || ((String)request.getParameter("_reverse")).equals("true")) || request.getParameter("_ordered")==null ){
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","false","_ordered","saldo")%>' class="reportOrder">
                              <bean:message key="report.orderedasc"/>
                            </a>
                            <%
                          } else {
                            %>
                            <a href='MaioresClientesLimiteCredito_rForm.jsp<%=com.egen.util.servlet.Parameter.reWriteUrl(request,"_reverse","true","_ordered","saldo")%>' class="reportOrder">
                              <bean:message key="report.ordereddesc"/>
                            </a>
                            <%
                          }
          ...
          %>
          <html:form action="adm/MaioresClientesLimiteCredito_rForm.do" method="post" styleClass="baseForm">
