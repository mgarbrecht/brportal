...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/ChequesCLDActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = ChequesCLDActionForm;
  ...
  <center>
    <body onload="if(document.forms[0].rep.value=='' && document.forms[0].reg.value==''){document.forms[0].codigo_regional.focus();}">
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            <table class="headerTable" style="width:99%" >
              <tr>
                ...
                <td class="td10">
                  ...
                  <%
                  if(!user.isSuperUsuario() && !user.isAutorizado(63)){
            ...
            <html:form action="adm/ChequesCLDForm.do" method="post" styleClass="baseForm" target="_self">
              <table class="messageTable" style='width:99%;'>
                <tr class="messageTr" >
                  <td class="messageTd">
                    ...
                    <html:errors property="ActionErrors.GLOBAL_ERROR_bl_form_Jw_cheques_cld"/>
                  </td>
                </tr>
              </table>
              ...
              <table class="itemTable"  style="width:99%;">
                ...
                if((codigo_regional.equals("")) && (codigo_representante.equals(""))) {
                  ...
                  <tr class="itemTr">
                    ...
                    <td class="formField">
                      <html:text property="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'ChequesCLDActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3" maxlength="3"/>
