      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="adm/UploadArquivosForm.do" method="post" styleClass="baseForm">
              ...
              <table class="buttonTable" style='width:99%;'>
                <tr class="buttonTr">
                  ...
                  <SCRIPT>
                    ...
                    <html:button value="Cadastrar Novo Arquivo" onclick="cadastrar_action.click();" styleClass="baseButton" property="cadastrar1_action"></html:button>
                    ...
                    <html:submit value="Blank" styleClass="myhidden" property="cadastrar_action"></html:submit>
                    </td>
                    </tr>
                    </table>
