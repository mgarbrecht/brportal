        ...
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <%
            {
              ...
              <form  name="bl_report_Jw_limite_credito_disponivel" id="bl_report_Jw_limite_credito_disponivel" class="baseForm" method="post" >
                <%
                if (res_Jw_limite_credito_disponivel!=null && res_Jw_limite_credito_disponivel.size()>0) {
                  %>

                  <table id="TRbl_report_Jw_limite_credito_disponivel"  class="reportTable"   style="width:99%; "  border="1" >
                    <%
                    ...
                    double sum_valor_analista_1 = 0;
                    double sum_valor_saldo_1 = 0;
                    double sum_disponivel_1 = 0;
                    ...
                    while (i_bl_report_Jw_limite_credito_disponivel<res_Jw_limite_credito_disponivel.size()) {
                      portalbr.dbobj.view.Jw_limite_credito_disponivel t_jw_limite_credito_disponivel = (portalbr.dbobj.view.Jw_limite_credito_disponivel)res_Jw_limite_credito_disponivel.elementAt(i_bl_report_Jw_limite_credito_disponivel);
                      ...
                      sum_valor_analista_1 += valor_analista;
                      sum_valor_saldo_1 += valor_saldo;
                      sum_disponivel_1 += disponivel;
                      String _b0_value = (grupo_economico==null?"":grupo_economico);
                      ...
                      String style_bl_report_Jw_limite_credito_disponivel="";
                      if (!((i_bl_report_Jw_limite_credito_disponivel%2)!=0)) {
                        style_bl_report_Jw_limite_credito_disponivel="rowColor";
                      } else {
                        style_bl_report_Jw_limite_credito_disponivel="rowBlank";
                      }
                      %>

                      <tr class='<%= style_bl_report_Jw_limite_credito_disponivel %>' id="TRbl_report_Jw_limite_credito_disponivel<%=i_bl_report_Jw_limite_credito_disponivel%>" >
                      ...
                      i_bl_report_Jw_limite_credito_disponivel++;
                      if (i_bl_report_Jw_limite_credito_disponivel<res_Jw_limite_credito_disponivel.size()) {
                        ...
                        disponivel = t_jw_limite_credito_disponivel.getDisponivel();
                        perc = t_jw_limite_credito_disponivel.getPerc();
                        _b0_value = (grupo_economico==null?"":grupo_economico);
                      } else {
                        _b0_control = "__";
                      }
                      if (_b0_control != null && !_b0_control.equals(_b0_value)) {
                        ...
                        <tr class="totalColumn">
                          ...
                          <td class="totalTdColumn"  style="text-align:right; font-weight:bold;" >
                            <%= com.egen.util.text.FormatNumber.format(sum_valor_analista_1, "##,##0.00") %>
                          </td>
                          <td class="totalTdColumn"  style="text-align:right; font-weight:bold;" >
                            <%= com.egen.util.text.FormatNumber.format(sum_valor_saldo_1, "##,##0.00") %>
                          </td>
                          <td class="totalTdColumn"  style="text-align:right; font-weight:bold;" >
                            <%= com.egen.util.text.FormatNumber.format(sum_disponivel_1, "##,##0.00") %>
                          </td>
                          <td class="totalTdColumn"  style="text-align:right; font-weight:bold;" >
                            <%= com.egen.util.text.FormatNumber.format(((sum_valor_saldo_1*100)/sum_valor_analista_1), "##,##0.00") %>
                          </td>
                        </tr>

                        <%
                        sum_valor_analista_1 = 0;
                        sum_valor_saldo_1 = 0;
                        sum_disponivel_1 = 0;
                      }
                    }
            ...
            <html:form action="adm/LimiteCreditoDisponivel_rgForm.do" method="post" styleClass="baseForm">
