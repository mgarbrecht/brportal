...
<html>
  ...
  <script type="text/javascript" src="../dwr/interface/MaioresClientesLimiteCreditoActionForm.js">
  </script>
  <script type="text/javascript">
    var ActionFormClass = MaioresClientesLimiteCreditoActionForm;
      ...
      <table class="mainTable" style='width:99%;'>
        <tr class="mainTr">
          <td class="mainTd">
            ...
            <html:form action="adm/MaioresClientesLimiteCreditoForm.do" method="post" styleClass="baseForm">
              ...
              <table class="itemTable"  style="width:99%;">
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="codigo_regional" styleId="codigo_regional" onblur="fillFields(0,new Array('codigo_regional'),'MaioresClientesLimiteCreditoActionForm.getNome_regional_Ajax',new Array('nome_regional'));" styleClass="baseField" size="3"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="rep_cdgo" styleId="rep_cdgo" onblur="fillFields(0,new Array('rep_cdgo'),'MaioresClientesLimiteCreditoActionForm.getRep_rzao_Ajax',new Array('rep_rzao'));" styleClass="baseField" size="5"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="gre_grupo" styleId="gre_grupo" onblur="if(this.value!=''){fillFields(0,new Array('gre_grupo'),'MaioresClientesLimiteCreditoActionForm.getGre_descricao_Ajax',new Array('gre_descricao'));}else{gre_descricao.value='';}" styleClass="baseField" size="6" maxlength="10"/>
                ...
                <tr class="itemTr">
                  ...
                  <td class="formField">
                    <html:text property="cli_cdgo" styleId="cli_cdgo" onblur="if(this.value!=''){fillFields(0,new Array('cli_cdgo'),'MaioresClientesLimiteCreditoActionForm.getCli_rzao_Ajax',new Array('cli_rzao'));}else{cli_rzao.value='';}" styleClass="baseField" size="10" maxlength="22"/>
