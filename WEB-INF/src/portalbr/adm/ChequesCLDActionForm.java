...
public class ChequesCLDActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public String[][] getNome_regional_Ajax(ChequesCLDActionForm PARAM) {
