 ...
 * Last Modify Date 10/12/2020 18:52:18
 */

public class Clientes_quantidade_atendimentos_representanteAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_quantidade_atendimentos_representante", new ActionMessage("error.action.exception",com.egen.util.system.Error.getMessage(e)));
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    Clientes_quantidade_atendimentos_representanteActionForm f = (Clientes_quantidade_atendimentos_representanteActionForm) form;
    portalbr.dbobj.view.Jw_clientes_quantidade_atendimentos_representante table = new portalbr.dbobj.view.Jw_clientes_quantidade_atendimentos_representante();
    ...
    query.append("                      , pck_regionais_vendas.get_nome(r.codigo_regional) nome_regional ");
    ...
    Vector res_Clientes_quantidade_atendimentos_representante = j.select(table, query.toString(), null);

    session.setAttribute("res_Clientes_quantidade_atendimentos_representante", res_Clientes_quantidade_atendimentos_representante);
    if (!(res_Clientes_quantidade_atendimentos_representante != null && res_Clientes_quantidade_atendimentos_representante.size() > 0)) {
      ActionErrors errors = (ActionErrors) request.getAttribute(org.apache.struts.Globals.ERROR_KEY);
      if (errors == null) {
        errors = new ActionErrors();
      }
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_quantidade_atendimentos_representante", new ActionMessage("warn.norowsselected",""));
      request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
    }
  ...
  public ActionForward perform_resetfull_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      Clientes_quantidade_atendimentos_representanteActionForm f = (Clientes_quantidade_atendimentos_representanteActionForm) form;
      session.removeAttribute("res_Clientes_representante");
