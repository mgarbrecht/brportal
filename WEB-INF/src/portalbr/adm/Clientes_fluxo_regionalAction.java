 ...
 * Last Modify Date 25/03/2020 16:18:16
 */

public class Clientes_fluxo_regionalAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_fluxo_regional", new ActionMessage("error.action.exception",com.egen.util.system.Error.getMessage(e)));
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    Clientes_fluxo_regionalActionForm f = (Clientes_fluxo_regionalActionForm) form;
    portalbr.dbobj.view.Jw_fluxo_regional table = new portalbr.dbobj.view.Jw_fluxo_regional();
    ...
    Vector res_Clientes_fluxo_regional = j.select(table, query.toString(), null);

    session.setAttribute("res_Clientes_fluxo_regional",res_Clientes_fluxo_regional);
    if (!(res_Clientes_fluxo_regional != null && res_Clientes_fluxo_regional.size() > 0)) {
      ActionErrors errors = (ActionErrors) request.getAttribute(org.apache.struts.Globals.ERROR_KEY);
      if (errors == null) {
        errors = new ActionErrors();
      }
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_fluxo_regional", new ActionMessage("warn.norowsselected",""));
      request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
    }
  ...
  public ActionForward perform_resetfull_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      Clientes_fluxo_regionalActionForm f = (Clientes_fluxo_regionalActionForm) form;
      session.removeAttribute("res_Clientes_fluxo_regional");
