...
public class SugestaoClientesLimiteCreditoAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      SugestaoClientesLimiteCreditoActionForm f = (SugestaoClientesLimiteCreditoActionForm) form;
      select_action(j, mapping, form, request, response);
      actionForward = new ActionForward("/adm/SugestaoClientesLimiteCredito_rForm.jsp",true);
    } catch (Exception e) {
