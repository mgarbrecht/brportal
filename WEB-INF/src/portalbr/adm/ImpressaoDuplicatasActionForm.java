...
public class ImpressaoDuplicatasActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public ImpressaoDuplicatasActionForm() {
  }
  /**
  ...
  public java.util.Vector getEmp_empresaList() {
    if (emp_empresaList == null || emp_empresaList.size() == 0) {
      ...
      emp_empresaLabelList.addElement(bundle.getString("jsp.pleaseselect"));
      ...
      try {
        ...
        com.egen.util.logger.Logging.log("portalbr", java.util.logging.Level.INFO, "ImpressaoDuplicatas.", e);
      } finally {
        if (j != null) {
          j.close();
        }
