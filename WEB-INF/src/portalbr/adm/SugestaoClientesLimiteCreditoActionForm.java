 ...
 * Last Modify Date 21/08/2013 12:16:39
 */

public class SugestaoClientesLimiteCreditoActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public SugestaoClientesLimiteCreditoActionForm() {
  }
  /**
  ...
  public String[][] getNome_regional_Ajax(SugestaoClientesLimiteCreditoActionForm PARAM) {
  ...
  public String[][] getRep_rzao_Ajax(SugestaoClientesLimiteCreditoActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getGre_descricao_Ajax(SugestaoClientesLimiteCreditoActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCli_rzao_Ajax(SugestaoClientesLimiteCreditoActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
