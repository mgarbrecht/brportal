 ...
 * Last Modify Date 11/12/2020 10:13:44
 */

public class Clientes_quantidade_atendimentos_regionalAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_quantidade_atendimentos_regional", new ActionMessage("error.action.exception",com.egen.util.system.Error.getMessage(e)));
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    Clientes_quantidade_atendimentos_regionalActionForm f = (Clientes_quantidade_atendimentos_regionalActionForm) form;
    portalbr.dbobj.view.Jw_clientes_quantidade_atendimentos_regional table = new portalbr.dbobj.view.Jw_clientes_quantidade_atendimentos_regional();
    ...
    Vector res_Clientes_quantidade_atendimentos_regional = j.select(table, query.toString(), null);
    session.setAttribute("res_Clientes_quantidade_atendimentos_regional", res_Clientes_quantidade_atendimentos_regional);
    if (!(res_Clientes_quantidade_atendimentos_regional != null && res_Clientes_quantidade_atendimentos_regional.size() > 0)) {
      ActionErrors errors = (ActionErrors) request.getAttribute(org.apache.struts.Globals.ERROR_KEY);
      if (errors == null) {
        errors = new ActionErrors();
      }
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Clientes_quantidade_atendimentos_regional", new ActionMessage("warn.norowsselected",""));
      request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
    }
