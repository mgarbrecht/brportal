...
public class Clientes_comprasAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Jw_clientes_compras", new ActionMessage("error.action.exception",com.egen.util.system.Error.getMessage(e)));
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    HttpSession session = request.getSession(true);
    Clientes_comprasActionForm f = (Clientes_comprasActionForm) form;
    ...
    try {
      ...
      query.append("         , cli_dult ");
      query.append("         , limite_credito ");
      query.append("    HAVING COUNT(DISTINCT mes_ano) = ").append(f.getMeses());
      ...
      if (!(res_Jw_clientes_atendidos != null && res_Jw_clientes_atendidos.size() > 0)) {
        ...
        errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Jw_clientes_compras", new ActionMessage("warn.norowsselected",""));
        request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
      }
    }
    finally {
