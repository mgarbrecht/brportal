 ...
 * Last Modify Date 23/11/2009 09:36:52
 */

public class GruposNaoAtendidosAction extends com.egen.util.struts.AbstractAction {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    HttpSession session = request.getSession(true);
    GruposNaoAtendidosActionForm f = (GruposNaoAtendidosActionForm) form;
    StringBuilder parametros = new StringBuilder();
    StringBuilder parametros1 = new StringBuilder();
    ...
    if ((!((f.getCod_marca() + "").equals("null")))) {
      parametros1.append(" and mapr.codigo_marca = ").append(f.getCod_marca());
    }

    if ((!((f.getCod_regional() + "").equals("null")))) {
      parametros1.append(" and reve.codigo_regional = ").append(f.getCod_regional());
    }

    if ((!((f.getCod_rep() + "").equals("null")))) {
      parametros1.append(" and repr.rep_cdgo = ").append(f.getCod_rep());
    }
    ...
    query.append(parametros1.toString());
    query.append(" minus ( ");
    query.append(" SELECT DISTINCT ");
