...
public class ConsultaPedidos_dAction extends com.egen.util.struts.AbstractAction {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    HttpSession session = request.getSession(true);
    ConsultaPedidos_dActionForm f = (ConsultaPedidos_dActionForm) form;
    portalbr.dbobj.table.Ped table = new portalbr.dbobj.table.Ped();
    String[][] select = null;
    Object[][] where = { {"Rep_cdgo","like", f.getRep_cdgo()}, {"Ped_nped","like", f.getPed_nped()} };
    ...
    if (!(res_Ped != null && res_Ped.size() > 0)) {
      ...
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Ped", new ActionMessage("warn.norowsselected",""));
      request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
    }
