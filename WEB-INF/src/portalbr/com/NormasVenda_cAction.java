...
public class NormasVenda_cAction extends com.egen.util.struts.AbstractAction {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    Object[][] where = { {"Lidi_marca","=", com.egen.util.text.FormatNumber.toInt(f.getLidi_marca())}, {"Lidi_tipo","like", cliente } };
