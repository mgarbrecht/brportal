 ...
 * Last Modify Date 16/03/2016 14:32:26
 */

public class GeracaoRomaneioActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public GeracaoRomaneioActionForm() {
  }
  /**
  ...
  public String[][] getFil_razsoc_Ajax(GeracaoRomaneioActionForm PARAM) {
  ...
  public String[][] getRep_rzao_Ajax(GeracaoRomaneioActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCli_rzao_Ajax(GeracaoRomaneioActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  Vector preco_final_liquidoList = new Vector(10, 1);
  public java.util.Vector getPreco_final_liquidoList() {
    if (preco_final_liquidoList == null || preco_final_liquidoList.size() == 0) {
      preco_final_liquidoList.addElement("S");
      preco_final_liquidoLabelList.addElement("Sim");
      preco_final_liquidoList.addElement("N");
      preco_final_liquidoLabelList.addElement("Não");
    }
    java.util.Vector list = preco_final_liquidoList;
    return list;
  }
  java.util.Vector preco_final_liquidoLabelList = new Vector(10, 1);
  public java.util.Vector getPreco_final_liquidoLabelList() {
    java.util.Vector list = preco_final_liquidoLabelList;
    return list;
  }
  /**
