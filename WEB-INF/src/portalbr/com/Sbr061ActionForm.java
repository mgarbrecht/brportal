 ...
 * Last Modify Date 26/02/2008 12:16:50
 */

public class Sbr061ActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public String[][] getNome_regional_Ajax(Sbr061ActionForm PARAM) {
...
public String[][] getRep_rzao_Ajax(Sbr061ActionForm PARAM) {
  String[][] list = new String[1][2];
com.egen.util.jdbc.JdbcUtil j = null;
try {
  if (PARAM.getRep_cdgo() !=null && PARAM.getRep_cdgo().length()>0) {
    ...
    Rep db_object = new Rep();
    Object[][] where = {
      {"rep_cdgo","like",PARAM.getRep_cdgo()},
      };
    String[] order = null;
    java.util.Vector results = j.select(db_object, where, order);
    if (results!=null && results.size()>0) {
...
try {
  if (pf_marca_ini !=null && pf_marca_ini.length()>0) {
    ...
    Object[][] where = {
      {"codigo_marca","=",com.egen.util.text.FormatNumber.toInt(pf_marca_ini)},
      };
    String[] group = null;
    String[] having = null;
    String[] order = null;
...
public String[][] getDescricao_marca_Ajax(Sbr061ActionForm PARAM) {
  String[][] list = new String[1][2];
com.egen.util.jdbc.JdbcUtil j = null;
try {
  if (PARAM.getPf_marca_ini() !=null && PARAM.getPf_marca_ini().length()>0) {
    ...
    Marcas_produtos db_object = new Marcas_produtos();
    Object[][] where = {
      {"codigo_marca","like",PARAM.getPf_marca_ini()},
      };
    String[] order = null;
    java.util.Vector results = j.select(db_object, where, order);
    if (results!=null && results.size()>0) {
...
try {
  if (pf_marca_fim !=null && pf_marca_fim.length()>0) {
    ...
    Object[][] where = {
      {"codigo_marca","=",com.egen.util.text.FormatNumber.toInt(pf_marca_fim)},
      };
    String[] group = null;
    String[] having = null;
    String[] order = null;
...
public String[][] getDescricao_marca1_Ajax(Sbr061ActionForm PARAM) {
  String[][] list = new String[1][2];
com.egen.util.jdbc.JdbcUtil j = null;
try {
  if (PARAM.getPf_marca_fim() !=null && PARAM.getPf_marca_fim().length()>0) {
    ...
    Marcas_produtos db_object = new Marcas_produtos();
    Object[][] where = {
      {"codigo_marca","like",PARAM.getPf_marca_fim()},
      };
    String[] order = null;
    java.util.Vector results = j.select(db_object, where, order);
    if (results!=null && results.size()>0) {
