...
public class ArquivosFornecedoresActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public ArquivosFornecedoresActionForm() {
  }
  /**
  ...
  public String[][] getFil_razsoc_Ajax(ArquivosFornecedoresActionForm PARAM) {
  ...
  public String[][] getRep_rzao_Ajax(ArquivosFornecedoresActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCli_rzao_Ajax(ArquivosFornecedoresActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
