...
public class SolicitacaoCombinacaoEspecial_iActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public java.util.Vector getTipo_solicitacaoList() {
    if (tipo_solicitacaoList == null || tipo_solicitacaoList.size() == 0) {
      ...
      try {
        ...
        Object[][] where = {{"rv_domain","=","TIPO_SOLICITACAO_COMB_ESPECIAL"}, {"rv_low_value","not in","'11', '12', '4', '6', '7', '8', '9', '10'"} };
        ...
        com.egen.util.logger.Logging.log("portalbr", java.util.logging.Level.INFO, "SolicitacaoCombinacaoEspecial_i.", e);
      } finally {
        if (j != null) {
          j.close();
        }
  ...
  public java.util.Vector getSubtipo_solicitacao_comb_especList() {
    ...
    try {
      ...
      Cg_ref_codes db_object = new Cg_ref_codes();
      String[][] select = {{"rv_low_value", null},{"rv_meaning", null}};
      Object[][] where = {{"rv_domain","=","SUBTIPO_SOLICITACAO_COMB_ESPEC"}, {"rv_high_value","in","'" + this.tipo_solicitacao + "'"} };
      String[] order = {"rv_meaning"};
      String[] groupby = null;
      String[] having = null;
      Vector results = j.select(db_object, select, where, groupby, having, order);
  ...
  public String[][] getRef_cdgo_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    ...
    try {
      if (PARAM.getLin_cdgo() != null && PARAM.getLin_cdgo().length() > 0 && PARAM.getRef_cdgo() != null && PARAM.getRef_cdgo().length() > 0) {
        j = new com.egen.util.jdbc.JdbcUtil();
        Ref db_object = new Ref();
        Object[][] where = { {"lin_cdgo","=", com.egen.util.text.FormatNumber.toInteger(PARAM.getLin_cdgo())}, {"ref_cdgo","=",com.egen.util.text.FormatNumber.toInteger(PARAM.getRef_cdgo())}, };
        String[] order = null;
        java.util.Vector results = j.select(db_object, where, order);
        if (results != null && results.size() > 0) {
          db_object = (Ref) results.elementAt(0);
          ...
          System.out.println("achou: " + db_object.getRef_desc() + "" + " / " + db_object.getCodigo_marca() + "");
        } else {
  ...
  public String[][] getCab_desc_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
  ...
  public String[][] getCor_desc_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCli_rzao_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[3][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getRep_rzao_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCodigo_regional_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
      if (PARAM.getRep_cdgo() != null && PARAM.getRep_cdgo().length() > 0) {
  ...
  public String[][] getNome_regional_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getGre_descricao_Ajax(SolicitacaoCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  /**
    * LIBERA_VALORES: Método Gets para este campo
    */
  public boolean getLibera_valores() {
    return libera_valores;
  }
  /**
    * LIBERA_VALORES: Método Sets pára este campo.
    */
  public void setLibera_valores(boolean PARAM) {
    libera_valores = PARAM;
  }
  /**
  ...
  public ActionErrors validate(org.apache.struts.action.ActionMapping mapping, javax.servlet.http.HttpServletRequest request) {
    ...
    if (com.egen.util.text.Validate.isValidate("insert_action,", request)) {
      ...
      if (com.egen.util.text.Validate.isNull(material)) {
        errors.add("material", new ActionMessage("error.validate.notnull","Material","material","0"));
      }
