...
public class SolicitacaoCombinacaoEspecial_gAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      SolicitacaoCombinacaoEspecial_gActionForm[]_ge_grid_array = (SolicitacaoCombinacaoEspecial_gActionForm[])_ge_grid.get("bl_form_Jw_grade_solicitacao_especial_lines");
      SolicitacaoCombinacaoEspecial_gActionForm f = _ge_grid_array[0];
      try {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (f != null) {
      ...
      if (res_Jw_grade_solicitacao_especial != null && res_Jw_grade_solicitacao_especial.size() > 0) {
        SolicitacaoCombinacaoEspecial_gActionForm[]_ge_grid_array_flex = new SolicitacaoCombinacaoEspecial_gActionForm[res_Jw_grade_solicitacao_especial.size()];
        ...
        for (int _ge_grid_array_index = 0; _ge_grid_array_index < _ge_grid_array_flex.length; _ge_grid_array_index++, _ge_pos++) {
          if (_ge_grid_array_index < _ge_grid_array.length) {
            ...
            f = new SolicitacaoCombinacaoEspecial_gActionForm();
  ...
  public ActionForward perform_select1_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      j = new com.egen.util.jdbc.JdbcUtil();
      SolicitacaoCombinacaoEspecial_gActionForm f = (SolicitacaoCombinacaoEspecial_gActionForm) form;


      org.apache.struts.config.ModuleConfig moduleConfig = mapping.getModuleConfig();
      ActionMapping detailMapping = (ActionMapping) moduleConfig.findActionConfig("/com/SolicitacaoCombinacaoEspecial_gGrid");
      ...
      if (detailActionForm != null) {
        SolicitacaoCombinacaoEspecial_gActionForm[]_ge_grid_array = (SolicitacaoCombinacaoEspecial_gActionForm[]) detailActionForm.get("bl_form_Jw_grade_solicitacao_especial_lines");
        SolicitacaoCombinacaoEspecial_gActionForm f0 = _ge_grid_array[0];
        f0.setLin_cdgo(((SolicitacaoCombinacaoEspecial_gActionForm) form).getLin_cdgo1());
