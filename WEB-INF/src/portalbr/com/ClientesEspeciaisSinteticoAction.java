...
public class ClientesEspeciaisSinteticoAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      ClientesEspeciaisSinteticoActionForm f = (ClientesEspeciaisSinteticoActionForm) form;
      acesso.Usuario usuario = (acesso.Usuario) session.getAttribute("User");
      if (usuario.mostraQuery()) {
        throw new Exception("Query não disponível! Relatório utilizado: cli0015.rdf");
      }
      util.file.GeraPDF g = new util.file.GeraPDF(request);
      g.setRelatorio("cli0015.rdf");
      //--------------------------------------------------------------------------
      ...
      //--- pesquisa pra verificar se o cliente pertence ao usuario --------------------------
      try {
        if (f.getCli_cdgo() != "") {
          ...
          query.append("        c.codigo_regional codigo_regional ");
