...
public class PosicaoAmostras_oActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public PosicaoAmostras_oActionForm() {
  }
  /**
  ...
  public ActionErrors validate(org.apache.struts.action.ActionMapping mapping, javax.servlet.http.HttpServletRequest request) {
    ...
    if (com.egen.util.text.Validate.isValidate("insert_action,", request)) {
      ...
      if (com.egen.util.text.Validate.isNull(observacao)) {
        errors.add("observacao", new ActionMessage("error.validate.notnull","Observação Atendente","observacao","0"));
      }
    }
