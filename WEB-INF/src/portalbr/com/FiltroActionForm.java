...
public class FiltroActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public String[][] getDescricao_marca_Ajax(FiltroActionForm PARAM) {
  ...
  public String[][] getLin_nome_Ajax(FiltroActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  /**
    * INSERT_NORMA: Método Gets para este campo
    */
  public String getInsert_norma() {
    return insert_norma;
  }
  /**
    * INSERT_NORMA: Método Sets pára este campo.
    */
  public void setInsert_norma(String PARAM) {
    insert_norma = PARAM;
  }
  /**
    * INSERT_ITEM: Método Gets para este campo
    */
  public String getInsert_item() {
    return insert_item;
  }
  /**
    * INSERT_ITEM: Método Sets pára este campo.
    */
  public void setInsert_item(String PARAM) {
    insert_item = PARAM;
  }
  /**
    * INSERT_LINHA: Método Gets para este campo
    */
  public String getInsert_linha() {
    return insert_linha;
  }
  /**
    * INSERT_LINHA: Método Sets pára este campo.
    */
  public void setInsert_linha(String PARAM) {
    insert_linha = PARAM;
  }
  /**
    * INSERT_REFERENCIA: Método Gets para este campo
    */
  public String getInsert_referencia() {
    return insert_referencia;
  }
  /**
    * INSERT_REFERENCIA: Método Sets pára este campo.
    */
  public void setInsert_referencia(String PARAM) {
    insert_referencia = PARAM;
  }
  /**
    * INSERT_CABEDAL: Método Gets para este campo
    */
  public String getInsert_cabedal() {
    return insert_cabedal;
  }
  /**
    * INSERT_CABEDAL: Método Sets pára este campo.
    */
  public void setInsert_cabedal(String PARAM) {
    insert_cabedal = PARAM;
  }
  /**
    * INSERT_COR: Método Gets para este campo
    */
  public String getInsert_cor() {
    return insert_cor;
  }
  /**
    * INSERT_COR: Método Sets pára este campo.
    */
  ...
  public ActionErrors validate(org.apache.struts.action.ActionMapping mapping, javax.servlet.http.HttpServletRequest request) {
    ...
    valida = false;
    if (com.egen.util.text.Validate.isValidate("insert_action,insert_item_action,insert_cor_action,delete_item_action,delete_cor_action,", request)) {
    }
