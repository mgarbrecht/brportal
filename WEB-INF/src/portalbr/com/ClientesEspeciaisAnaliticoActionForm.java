...
public class ClientesEspeciaisAnaliticoActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public ClientesEspeciaisAnaliticoActionForm() {
  }
  /**
  ...
  public String[][] getNome_regional_Ajax(ClientesEspeciaisAnaliticoActionForm PARAM) {
  ...
  public String[][] getCli_rzao_Ajax(ClientesEspeciaisAnaliticoActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
