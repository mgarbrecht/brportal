...
public class DiarioCombinacaoEspecial_iActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public DiarioCombinacaoEspecial_iActionForm() {
  }
  /**
  ...
  public java.util.Vector getCodigo_marcaList() {
    if (codigo_marcaList == null || codigo_marcaList.size() == 0) {
      ...
      try {
        ...
        com.egen.util.logger.Logging.log("portalbr", java.util.logging.Level.INFO, "DiarioCombinacaoEspecial_i.", e);
      } finally {
        if (j != null) {
          j.close();
        }
  ...
  public String[][] getLin_nome_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
  ...
  public String[][] getRef_desc_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCab_desc_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCor_desc_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getCli_rzao_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getRep_rzao_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
  ...
  public String[][] getGre_descricao_Ajax(DiarioCombinacaoEspecial_iActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
