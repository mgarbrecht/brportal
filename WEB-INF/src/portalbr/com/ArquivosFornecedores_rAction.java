 ...
 * Last Modify Date 10/08/2015 08:30:14
 */

public class ArquivosFornecedores_rAction extends com.egen.util.struts.AbstractAction {
  ...
  public ActionForward perform_select_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      ArquivosFornecedores_rActionForm[]_ge_grid_array = (ArquivosFornecedores_rActionForm[])_ge_grid.get("bl_form_Jw_geracao_romaneio_filtro_lines");
      ArquivosFornecedores_rActionForm f = _ge_grid_array[0];
      try {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    if (f != null) {
      ...
      if (res_Jw_geracao_romaneio_filtro != null && res_Jw_geracao_romaneio_filtro.size() > 0) {
        ArquivosFornecedores_rActionForm[]_ge_grid_array_flex = new ArquivosFornecedores_rActionForm[res_Jw_geracao_romaneio_filtro.size()];
        ...
        for (int _ge_grid_array_index = 0; _ge_grid_array_index < _ge_grid_array_flex.length; _ge_grid_array_index++, _ge_pos++) {
          if (_ge_grid_array_index < _ge_grid_array.length) {
            ...
            f = new ArquivosFornecedores_rActionForm();
  ...
  private void tg_marcar_todos_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    try {
      ...
      if (_ge_grid_array != null) {
        ArquivosFornecedores_rActionForm f = null;
  ...
  public ActionForward perform_back_action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    try {
      ...
      actionForward = new ActionForward("/com/ArquivosFornecedoresForm.jsp",true);
    } catch (Exception e) {
      ActionErrors errors = new ActionErrors();
      errors.add("ActionErrors.GLOBAL_ERROR_bl_form_Jw_geracao_romaneio_filtro", new ActionMessage("error.action.exception",com.egen.util.system.Error.getMessage(e)));
      request.setAttribute(org.apache.struts.Globals.ERROR_KEY, errors);
