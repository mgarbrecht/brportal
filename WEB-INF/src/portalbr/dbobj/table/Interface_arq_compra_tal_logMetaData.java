...
/** DataBase Object from table EDI.Interface_arq_compra_tal_log
  * @version 22/09/2016 08:45:15
  */
public class Interface_arq_compra_tal_logMetaData {

  public static final String SCHEMA = "EDI";

  /*** Table Primary Key fields. */
  public static final String[] PK = {"INTERFACE_ARQ_COMPRA_ID","REM_NRO","OCO_NUMERO","DATA_TRANSACAO"};

  /*** Data Base object name. */
  public static final String DB_OBJECT = "INTERFACE_ARQ_COMPRA_TAL_LOG";
