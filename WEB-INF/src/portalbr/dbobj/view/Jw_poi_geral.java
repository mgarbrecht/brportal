...
/** DataBase Object from table .Jw_poi_geral
  * @version 03/04/2013 09:17:06
  */
public class Jw_poi_geral implements java.io.Serializable, com.egen.util.jdbc.View {
  private double codigo_regional;
  private java.lang.String nome_regional;
  private double codigo_marca;
  ...
  private double pares_previsto;
  private double pares_faturado;
  private double pares_a_faturar;
  private double pares_realizado;
  private double dif_pares;
  private double prazo_medio;

  public Jw_poi_geral() {
  }

  public double getCodigo_regional() {
    return codigo_regional;
  }

  public void setCodigo_regional(double PARAM) {
  ...
  public double getCodigo_marca() {
    return codigo_marca;
  }

  public void setCodigo_marca(double PARAM) {
  ...
  public void setMedia_dia(double PARAM) {
    this.media_dia = PARAM;
  }

  public double getMedia_rep() {
    return media_rep;
  }

  public void setMedia_rep(double PARAM) {
    this.media_rep = PARAM;
  }
  ...
  public double getPares_previsto() {
    return pares_previsto;
  }

  public void setPares_previsto(double PARAM) {
    this.pares_previsto = PARAM;
  }

  public double getPares_faturado() {
    return pares_faturado;
  }

  public void setPares_faturado(double PARAM) {
    this.pares_faturado = PARAM;
  }

  public double getPares_a_faturar() {
    return pares_a_faturar;
  }

  public void setPares_a_faturar(double PARAM) {
    this.pares_a_faturar = PARAM;
  }

  public double getPares_realizado() {
    return pares_realizado;
  }

  public void setPares_realizado(double PARAM) {
  ...
  public double getPrazo_medio() {
    return prazo_medio;
  }

  public void setPrazo_medio(double PARAM) {
    this.prazo_medio = PARAM;
  }
