...
public class LvRepresentante2Action extends com.egen.util.struts.AbstractAction {
  ...
  private void select_action(JdbcUtil j, ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
    HttpSession session = request.getSession(true);
    LvRepresentante2ActionForm f = (LvRepresentante2ActionForm) form;
    portalbr.dbobj.table.Rep table = new portalbr.dbobj.table.Rep();
    String[][] select = null;
    String[] order = {"rep_rzao"};
    Object[][] where = { {"Rep_cdgo","like", f.getRep_cdgo()}, {"upper(Rep_rzao)","like", f.getRep_rzao().toUpperCase()}, {"Codigo_regional","=", com.egen.util.text.FormatNumber.toInt(f.getCodigo_regional())}, {"Rep_situ","=","A"} };
