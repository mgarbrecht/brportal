...
public class CadastroClientesMercadoExternoActionForm extends org.apache.struts.action.ActionForm
{
  public String cli_cdgo;
  public String cli_rzao;
  public String senha;
  private boolean valida = false;
  public CadastroClientesMercadoExternoActionForm() {
  }
  /**
  ...
  public String[][] getCli_rzao_Ajax(CadastroClientesMercadoExternoActionForm PARAM) {
  ...
  public ActionErrors validate(org.apache.struts.action.ActionMapping mapping, javax.servlet.http.HttpServletRequest request) {
    ...
    if (com.egen.util.text.Validate.isValidate("insert_action,update_action,", request)) {
      ...
      if (com.egen.util.text.Validate.isNull(senha)) {
        errors.add("senha", new ActionMessage("error.validate.notnull","Senha","senha","0"));
      }
    }
