...
public class AcessosTrocaIdentidadeActionForm extends org.apache.struts.action.ActionForm
{
  ...
  public AcessosTrocaIdentidadeActionForm() {
  }
  /**
  ...
  public String[][] getUsua_nome_Ajax(AcessosTrocaIdentidadeActionForm PARAM) {
  ...
  public String[][] getTien_tipo_Ajax(AcessosTrocaIdentidadeActionForm PARAM) {
    String[][] list = new String[1][2];
    com.egen.util.jdbc.JdbcUtil j = null;
    try {
